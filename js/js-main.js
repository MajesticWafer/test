    ...
    gascript.setAttribute(
      "src",
      "https://www.googletagmanager.com/gtag/js?id=UA-159383230-1"
    );
  ...
  gtag('config', 'UA-159383230-1');`;
    ...
    //Fetch visit count
    const visitapi =
      "https://api.countapi.xyz/update/weblfg/894b3dcd-ec09-40e8-ad52-6d5f4e5e984a/?amount=1";
    fetch(visitapi)
      .then((res) => res.json())
      .then((res) => {
        document.getElementById("visit-count").innerText =
          " " + parseInt(res.value).toLocaleString("en-US"); //Add commas
      });
    ...
    banner.innerHTML = `<p>Site Outdated. Use&nbsp<a href="https://weblfg.com/">weblfg.com</a>&nbspor join the&nbsp<a href="https://discord.gg/yXJgyuByYZ">Discord</a>&nbspif the link doesn't work.</p>`
